...
old = '''            {/* Botón normal en desktop, se oculta en móvil (ahí usamos el sticky de abajo) */}
...
new = '''            {/* Botón normal en desktop, se oculta en móvil (ahí usamos el sticky de abajo) */}
...
with open(path, "w") as f:
    f.write(content)
print("OK: boton de consulta agregado")
