    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative flex flex-col items-center px-6 pt-14">
        ...
        <div className="w-full max-w-sm flex flex-col gap-3">
          <a
            href="/"
            className="flex items-center gap-4 w-full bg-white hover:bg-cream/60 text-brown-dark rounded-2xl px-5 py-4 border border-brown/10 shadow-lg transition-colors"
          >
            <span className="w-14 h-14 rounded-full bg-brown-dark/10 text-brown-dark flex items-center justify-center shrink-0">
              <BagIcon />
            </span>
