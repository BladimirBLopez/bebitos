    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative flex flex-col items-center px-6 pt-14">
        ...
        <div className="w-full max-w-sm flex flex-col gap-3">
          <a
            href="/"
            className="flex items-center gap-3 w-full min-h-[76px] bg-white hover:bg-cream/60 text-brown-dark rounded-[28px] px-5 py-3.5 border border-brown/10 shadow-lg transition-colors"
          >
            <span className="w-12 h-12 text-brown-dark flex items-center justify-center shrink-0">
              <BagIcon />
            </span>
